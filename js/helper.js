...
var HTMLemail = '<li class="flex-item"><span class="cadetblue-text">email</span><span class="white-text">%data%</span></li>';
var HTMLtwitter = '<li class="flex-item"><span class="cadetblue-text">twitter</span><span class="white-text">%data%</span></li>';
...
var HTMLprojectStart = '<div class="row project-entry"><div class="project-detail col-md-8"></div></div>';
var HTMLprojectTitle = '<a href="#">%data%</a>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<p><br>%data%</p>';
var HTMLprojectImage = '<div id="project-image" class="col-md-4"><img class="img-responsive" src="%data%"></div>';
